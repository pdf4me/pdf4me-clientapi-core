...
The [Pdf4me Client API](https://developer.pdf4me.com/docs/api/getting-started/) is a .NET Core library which connects to its highly scalable SaaS cloud service with many functionalities 
